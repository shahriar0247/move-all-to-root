...
<h2>Instructions</h2>
<ol>
  <li>put the copy/move _all file into the folder where you want your file to appear (the root folder)</li>
  <li>run copy_all to copy all files into root folder</li>
  <li>run move_all to move all files into root folder</li>
